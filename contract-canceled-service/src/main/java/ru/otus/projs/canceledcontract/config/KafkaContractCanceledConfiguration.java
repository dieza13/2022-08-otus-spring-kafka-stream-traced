package ru.otus.projs.canceledcontract.config;
...
import ru.otus.projs.canceledcontract.service.ContractCanceledService;
...
@Configuration
public class KafkaContractCanceledConfiguration {

    private final ContractCanceledService contractCanceledService;

    @Bean
    public Consumer<KStream<String, TracedContractInfo>> contractOnCanceledProcess() {
        return input -> input
                .foreach((id, contract) -> contractCanceledService.onCanceledContract(contract));
    }
